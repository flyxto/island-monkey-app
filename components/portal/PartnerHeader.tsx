...
export function PartnerHeader({ isCompact = false, isProfile = false }: PartnerHeaderProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between">
        ...
        >
          ...
          <Link
            ...
            title={isProfile ? undefined : "Store Profile"}
            onClick={(e) => {
          ...
          {/* Name & Role & Edit Store Button Column */}
          <div className="flex flex-col justify-center min-w-0 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]">
            ...
            {/* Edit Store Button: Smoothly expands on profile, collapses on other pages */}
            <div
        ...
        {/* Right Side: Scan Shortcut (hidden on scan/profile) + Notification Bell */}
        <div
      ...
      {/* Centered Daily Processed Points: Only on Home page */}
      {!isProfile && (
        <div
      ...
      {!isProfile && (
        ...
        >
          ...
          <span>1 Point = 200 LKR Redemption Value</span>
        </div>
      )}
    </header>
  );
