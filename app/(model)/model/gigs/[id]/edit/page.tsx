...
export default function EditGigPage() {
    ...
    async function loadGig() {
      try {
        ...
        form.reset({
          ...
          hourlyRateLkr: gigData.hourlyRateLkr || gigData.hourlyRateLKR || 0,
          durationHours: gigData.durationHours || "",
          venueName: gigData.venueName || "",
          highlightTitle: gigData.highlightTitle || "",
          highlightSubtitle: gigData.highlightSubtitle || "",
          whatsIncluded: Array.isArray(gigData.whatsIncluded) ? gigData.whatsIncluded.join(", ") : "",
          coverImageUrl: gigData.coverImageUrl || "",
        });
      } catch (err: any) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      await updateGig(id, parsedValues);
    ...
    <div className="flex flex-col gap-8 pt-4 pb-12 max-w-2xl mx-auto w-full">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-im-muted text-sm mt-1">Update the details of your service</p>
        </div>
      </div>
